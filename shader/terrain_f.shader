...
Material material = Material(vec4(1, 1, 1, 1), vec4(0.6, 0.6, 0.6, 1), vec4(0, 0, 0, 0), 0.2, 0.4, 0.0);
...
vec4 processDirectionalLight(DirectionalLight light) {
    ...
    vec4 diffuse = light.color * fragColor * diffuseCoefficient;
